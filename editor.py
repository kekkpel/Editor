...
class Menubar:
    ...
    def show_about_message(self):
        ...
        box_message = "Un semplice Editor di Testo creato con Python e Tkinter da Francesco studente delle Medie"
        messagebox.showinfo(box_title, box_message)
        
    def show_release_notes(self):
        box_title= "Note di Rilascio"
        box_message = "Versione 0.1 - Beta - Data creazione 12/01/2020"
        messagebox.showinfo(box_title, box_message)
...
class Statusbar:
       ...
       def __init__(self, parent):
           ...
           self.status.set("Pytext - 0.1 Beta")
